...
namespace RPA_GetDataLink
{
    public class WorkflowRunnerService
    {
        ...
        /// <summary>
        /// Invokes the GetLinkFromHtml.xaml
        /// </summary>
        public (System.Data.DataTable io_dt_Link, bool io_bolEndPage) GetLinkFromHtml(string in_strHtml, string in_strPattern, System.Data.DataTable io_dt_Link, bool io_bolEndPage)
        {
            var result = _services.WorkflowInvocationService.RunWorkflow(@"GetLinkFromHtml.xaml", new Dictionary<string, object>{{"in_strHtml", in_strHtml}, {"in_strPattern", in_strPattern}, {"io_dt_Link", io_dt_Link}, {"io_bolEndPage", io_bolEndPage}}, default, default, default, GetAssemblyName());
        ...
        /// </summary>
		/// <param name="isolated">Indicates whether to isolate executions (run them within a different process)</param>
        public (System.Data.DataTable io_dt_Link, bool io_bolEndPage) GetLinkFromHtml(string in_strHtml, string in_strPattern, System.Data.DataTable io_dt_Link, bool io_bolEndPage, System.Boolean isolated)
        {
            var result = _services.WorkflowInvocationService.RunWorkflow(@"GetLinkFromHtml.xaml", new Dictionary<string, object>{{"in_strHtml", in_strHtml}, {"in_strPattern", in_strPattern}, {"io_dt_Link", io_dt_Link}, {"io_bolEndPage", io_bolEndPage}}, default, isolated, default, GetAssemblyName());
            return ((System.Data.DataTable)result["io_dt_Link"], (bool)result["io_bolEndPage"]);
        }
        ...
        /// </summary>
        public int GetTotalPage(string in_strPattern, string in_strUrl, int in_intSizeInPage)
        {
            ...
            return (int)result["out_intTotalPage"];
        }
        ...
        /// </summary>
		/// <param name="isolated">Indicates whether to isolate executions (run them within a different process)</param>
        public int GetTotalPage(string in_strPattern, string in_strUrl, int in_intSizeInPage, System.Boolean isolated)
        {
